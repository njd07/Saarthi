...
- 📺 **Interactive Smart Board:** Generates 10-part visual lessons including process flowcharts, AI diagrams, real-life Indian analogies, and LaTeX math.
...
- 🏆 **Interactive Quiz Mode:** Click-to-answer MCQs or type custom answers. Includes a compulsory typed-answer final question, live AI grading (score out of 20 per question based on depth), and a final scorecard dialog showing the score out of 100 with improvement tips.
...
- ✍️ **Dictate Mode:** Speak in Hinglish and get instant parallel output in Hinglish (romanized), Hindi (Devanagari), and English.
- 📚 **Textbook Voice Summary:** Get an instant Voice Co-Pilot audio summary of your uploaded textbooks in the library, generated by Groq and played aloud with Edge TTS.
